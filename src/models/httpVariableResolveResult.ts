...
export const enum ResolveWarningMessage {
    ...
    IncorrectFileContentVariableFormat = 'File system variable should follow format "{{$file path [raw|base64|json]}}", where path may be quoted if it contains spaces',
    FileContentFileNotFound = 'File is not found for the path given to the $file system variable',
    FileContentReadFailure = 'File given to the $file system variable could not be read',
